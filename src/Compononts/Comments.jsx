        ...
        <div className="gap-3 pb-6 sm:flex sm:items-start">
          <div className="shrink-0 space-y-2 sm:w-48 md:w-72 ">
            ...
            <div className="space-y-0.5">
              <p className="text-base font-semibold text-gray-900 dark:text-white">{item.reviewerName}</p>
              <p className="text-sm font-normal text-gray-500 dark:text-gray-400">{item.date}</p>
            </div>
