...
function ProductPage() {
  const { id } = useParams();
  const { addToBasket, decreaseFromBasket, loading, setLoading } = useContext(ContextPage);
  ...
  return (
    <>
      <section className="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased ">
        ...
        <div id="comm" className="max-w-screen-xl px-4 mx-auto 2xl:px-0  bg-white antialiased dark:bg-gray-900 border-2">
          <div className="mx-auto max-w-screen-xl px-4 2xl:px-0 ">
            <div className="flex items-center gap-2 my-2">
              ...
              <div className="mt-2 flex items-center gap-2 sm:mt-0">
                ...
                <a href="#" className="text-sm font-medium leading-none text-gray-900  dark:text-white">{reviews?.length} Yorum </a>
              </div>
