    ...
    return (
        <div className='flex-grow text-justify bg-gray-50 dark:bg-gray-900 dark:text-white'>
            ...
            <p>Bu amaçla;</p>
                ...
                <li>- Siz müşterilerimizi her zaman dinlemeye hazır olarak  sorunlarınızla ilgilenir ve çözüm için gereken desteği sunarız.
                </li>
                <li>- Müşteri bilgilerinin gizliliği ilkesine sadık kalarak hizmet sunarız.
                </li>
                <li>- Sadece ürünlerimizin satışı sırasında değil, satış sonrasında da memnuniyet sağlamak adına ürün ve hizmetlerimizin
                </li>
            </ul>
            <p>
